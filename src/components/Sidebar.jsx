...
const Sidebar = () => {
  return (
    <div className="flex h-screen font-sans max-sm:hidden">


      <aside className={`fixed top-0 left-0 h-full  transform `}>
        <div className="mt-16 flex flex-col ">
          <Link to={"/Home"}>
          <div className="flex flex-col  items-center p-4 text-white cursor-pointer hover:bg-gray-600">
            <svg
              className="w-8 h-8 "
              fill="currentColor"
              viewBox="0 0 20 20"
